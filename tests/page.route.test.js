...
describe('http requests', function () {
    ...
    describe('GET /wiki/:urlTitle', function () {
        ...
        xit('responds with 404 on page that does not exist', function () {
            return agent.get('/wiki/there_is_not_something_in_the_db_with_this_title').expect(404);
        });

        xit('responds with 200 on page that does exist', function () {
            return Page.create({
                title: 'Example Page',
    ...
    describe('GET /wiki/:urlTitle/similar', function () {
        ...
        xit('responds with 404 for page that does not exist', function () {
    ...
    describe('POST /wiki', function () {
        ...
        xit('creates a page in the database', function () {
            agent
                .post('/wiki/')
                .send({
                    authorName: 'Dan',
